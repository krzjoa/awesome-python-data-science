...
* [AutoIntent](https://github.com/deeppavlov/AutoIntent) - Extensible AutoML for multi-class and multi-label classification, out-of-scope detection and customizable search spaces.
