...
* [AutoIntent](https://github.com/deeppavlov/AutoIntent) - Extensible and customizable AutoML for multi-class/multi-label classification and out-of-scope detection.
