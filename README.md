...
* [FlexViz](https://github.com/flex-analytics/flexviz) - Interactive, cross-filtered dashboards on datasets too large to send to the browser; every zoom and selection is answered by a lazy Polars aggregation.
### Map
