...
* [mloda](https://github.com/mloda-ai/mloda) - Plugin-based feature engineering framework, framework-agnostic across pandas, polars, PyArrow, DuckDB and Spark, with built-in lineage tracing.
